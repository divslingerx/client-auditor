...
Aw, snap. I didn't want that to check _those_ links. Let's skip em:
...
- `path` (string|string[]) - A fully qualified path to the url to be scanned, or the path(s) to the directory on disk that contains files to be scanned. _required_.
